...
def newRestaurant():
    ...
    if request.method == 'POST':
        newrest = Restaurant(name = request.form['restname'], user_id = login_session['user_id'])
        session.add(newrest)
        session.commit()
...
def editRestaurant(restaurant_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('editrestaurant.html',restaurant_id=restaurant_id,rest=editedrest)
...
def deleteRestaurant(restaurant_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('deleterestaurant.html',restaurant_id=restaurant_id,rest=deletedrest)
...
def newMenuItem(restaurant_id):
    ...
    restaurant = session.query(Restaurant).filter_by(id=restaurant_id).one()
    if request.method == 'POST':
        newmenu = MenuItem(name = request.form['menuname'], description = request.form['menudesc'],\
                  price = request.form['menuprice'], course = request.form['menucourse'],restaurant_id=restaurant_id,\
...
#Edit Menu Item
@app.route('/restaurants/<int:restaurant_id>/menu/<int:id>/edit/', methods=['GET','POST'])
def editMenuItem(restaurant_id,id):
    ...
    if request.method == 'POST':
        ...
        return render_template("editmenuitem.html",restaurant_id=restaurant_id,id=id,editingmenu=editingmenu)

#Delete Menu Item
@app.route('/restaurants/<int:restaurant_id>/menu/<int:id>/delete/', methods = ['GET','POST'])
def deleteMenuItem(restaurant_id,id):
    ...
    if request.method == 'POST':
        ...
        return render_template("deletemenuitem.html",restaurant_id=restaurant_id,id=id,deletingmenu=deletingmenu)
